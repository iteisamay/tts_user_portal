...
const demoAudio = {
    id: "123",
    title: "Breaking News Audio Demo",
    desc: "This is a demo audio page for testing SEO and metadata.",
    language: "English",
    audio_key: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3",
    thumbnail: "/eisamay.png",
    thumbnail_alt: "Demo Audio Thumbnail",
    duration: "PT3M45S",
    tts_time: "2026-02-13T10:00:00Z",
    tts_mod_time: "2026-02-13T11:00:00Z",
};
...
export async function generateMetadata({ params }) {
    ...
    const title = formatText(demoAudio.title);
    const description = demoAudio.desc;
    ...
    return {
        ...
        openGraph: {
            title,
            description,
            url: `https://example.com/audio/${id}`,
            siteName: "Example Audio Site",
            images: [
                {
                    url: demoAudio.thumbnail,
                    width: 1200,
                    height: 630,
                    alt: demoAudio.thumbnail_alt || title,
                },
                {
                    url: "/eisamay.png",
                    width: 600,
        ...
        twitter: {
            ...
            title,
            description,
            images: [demoAudio.thumbnail],
        },
        other: {
            "og:audio": demoAudio.audio_key,
            "og:audio:secure_url": demoAudio.audio_key,
            "og:audio:type": "audio/mpeg",
        },
    };
}
...
export default async function AudioPage({ params }) {
    ...
    const title = formatText(demoAudio.title);
    const language = formatText(demoAudio.language);
    ...
    const jsonLd = {
        ...
        "@type": "AudioObject",
        name: title,
        description: demoAudio.desc,
        contentUrl: demoAudio.audio_key,
        encodingFormat: "audio/mpeg",
        duration: demoAudio.duration,
        inLanguage: demoAudio.language,
        thumbnailUrl: demoAudio.thumbnail,
        datePublished: demoAudio.tts_time,
        dateModified: demoAudio.tts_mod_time,
        publisher: {
            "@type": "Organization",
            name: "Demo Publisher",
            logo: {
    ...
    return (
        <>
            ...
            <NewsHead
                ...
                language={language}
                title={title}
                audioUrl={demoAudio.audio_key}
                thumbnail={demoAudio.thumbnail}
                publishedAt={demoAudio.tts_time}
                description={demoAudio.desc}
                duration={demoAudio.duration}
            />
        </>
